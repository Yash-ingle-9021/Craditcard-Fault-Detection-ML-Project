...
class TraininingPipeline:
    ...
    def run_pipeline(self):
        try:
            ...
            train_arr, test_arr, preprocessor_path = self.start_data_transformation(feature_store_file_path) #preprocessor_path
            accuracy = self.start_model_training(train_arr, test_arr,preprocessor_path)
